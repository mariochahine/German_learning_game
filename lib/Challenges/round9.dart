...
class round9 extends StatefulWidget {
  const round9({super.key});

  @override
  State<round9> createState() => _round9State();
}

class _round9State extends State<round9> {
  int i = getindex().geti();
  TextEditingController answer9 = TextEditingController();
  String corr='';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          title: const Text('Round 9', style: TextStyle(fontSize: 27)),
          centerTitle: true,
