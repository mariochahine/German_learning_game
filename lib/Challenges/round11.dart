...
class round11 extends StatefulWidget {
  const round11({super.key});

  @override
  State<round11> createState() => _round11State();
}

class _round11State extends State<round11> {
  int i = getindex().geti();
  TextEditingController answer11 = TextEditingController();
  String corr='';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          title: const Text('Round 11', style: TextStyle(fontSize: 27)),
          centerTitle: true,
