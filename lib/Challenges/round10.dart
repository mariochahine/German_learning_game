...
class round10 extends StatefulWidget {
  const round10({super.key});

  @override
  State<round10> createState() => _round10State();
}

class _round10State extends State<round10> {
  @override
  int i = getindex().geti();
  TextEditingController answer10 = TextEditingController();
  String corr='';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          title: const Text('Round 10', style: TextStyle(fontSize: 27)),
          centerTitle: true,
