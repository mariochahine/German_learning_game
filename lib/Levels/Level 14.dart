...
class _Level14State extends State<Level14> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          title: const Text('Level 14', style: TextStyle(fontSize: 25)),
          centerTitle: true,
            ...
            child: Center(
              child: Column(
                children: [
                  ...
                  SizedBox(height: 20),
                  Text('"Merry Christmas!"', style: TextStyle(fontSize: 22)),
                  SizedBox(height: 20),
                  ...
                  SizedBox(height: 30),
                  Text('"I have a question."', style: TextStyle(fontSize: 22)),
                  SizedBox(height: 20),
                  Text('“Ich hätte eine Frage.”',
                      style:
                      TextStyle(fontSize: 25, fontWeight: FontWeight.bold)),
                  SizedBox(height: 30),
                  ...
                  SizedBox(height: 30),
                  Text('"Could you please help me?"', style: TextStyle(fontSize: 22)),
                  SizedBox(height: 20),
