...
class _Level7State extends State<Level7> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          title: const Text('Level 7', style: TextStyle(fontSize: 25)),
          centerTitle: true,
            ...
            child: Center(
              child: Column(
                children: [
                  ...
                  SizedBox(height: 10),
                  Text('Transportation', style: TextStyle(fontSize: 24)),

                  SizedBox(height: 50),
                  Image.asset("images/hallo.png", height: 150),

                  SizedBox(height: 20),
                  Text('"Car"', style: TextStyle(fontSize: 22)),
                  SizedBox(height: 20),
                  Text('“Auto”',
                      style:
                  ...
                  SizedBox(height: 50),
                  Text('"Bus"', style: TextStyle(fontSize: 22)),
                  SizedBox(height: 20),
                  Text('“Bus”',
                      style:
                      TextStyle(fontSize: 25, fontWeight: FontWeight.bold)),
                  ...
                  SizedBox(height: 30),
                  Text('"Train"', style: TextStyle(fontSize: 22)),
                  SizedBox(height: 20),
                  Text('“Zug”',
                      style:
                      TextStyle(fontSize: 25, fontWeight: FontWeight.bold)),
                  ...
                  SizedBox(height: 50),
                  Text('"Bicycle"', style: TextStyle(fontSize: 22)),
                  SizedBox(height: 20),
                  Text('“Fahrrad”',
                      style:
                      TextStyle(fontSize: 25, fontWeight: FontWeight.bold)),
                  ...
                  SizedBox(height: 30),
                  Text('"Airplane"', style: TextStyle(fontSize: 22)),
                  SizedBox(height: 20),
                  Text('“Flugzeug ”',
                      style:
                      TextStyle(fontSize: 25, fontWeight: FontWeight.bold)),
